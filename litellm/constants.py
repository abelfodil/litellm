...
DEFAULT_MCP_SEMANTIC_FILTER_QUERY_REWRITE_ENABLED = (
    os.getenv("DEFAULT_MCP_SEMANTIC_FILTER_QUERY_REWRITE_ENABLED", "true").lower()
    == "true"
)
DEFAULT_MCP_SEMANTIC_FILTER_QUERY_REWRITE_MODEL: Optional[str] = os.getenv(
    "DEFAULT_MCP_SEMANTIC_FILTER_QUERY_REWRITE_MODEL", None
)
